...
GENRB_SOURCE = af.txt af_NA.txt af_ZA.txt agq.txt\
 ...
 ar_QA.txt ar_SA.txt ar_SD.txt ar_SO.txt ar_SY.txt\
 ar_TD.txt ar_TN.txt ar_YE.txt as.txt as_IN.txt\
 ...
 bs_Cyrl.txt bs_Cyrl_BA.txt bs_Latn.txt bs_Latn_BA.txt ca.txt\
 ca_AD.txt ca_ES.txt cgg.txt cgg_UG.txt chr.txt\
 chr_US.txt cs.txt cs_CZ.txt cy.txt cy_GB.txt\
 da.txt da_DK.txt dav.txt dav_KE.txt de.txt\
 de_AT.txt de_BE.txt de_CH.txt de_DE.txt de_LI.txt\
 de_LU.txt dje.txt dje_NE.txt dua.txt dua_CM.txt\
 dyo.txt dyo_SN.txt dz.txt dz_BT.txt ebu.txt\
 ebu_KE.txt ee.txt ee_GH.txt ee_TG.txt el.txt\
 el_CY.txt el_GR.txt en.txt en_150.txt en_AG.txt\
 ...
 en_MH.txt en_MP.txt en_MT.txt en_MU.txt en_MW.txt\
 en_NA.txt en_NG.txt en_NZ.txt en_PG.txt en_PH.txt\
 en_PK.txt en_PR.txt en_PW.txt en_SB.txt en_SC.txt\
 en_SG.txt en_SL.txt en_SS.txt en_SZ.txt en_TC.txt\
 en_TO.txt en_TT.txt en_TZ.txt en_UG.txt en_UM.txt\
 ...
 fr_TD.txt fr_TG.txt fr_TN.txt fr_VU.txt fr_YT.txt\
 ga.txt ga_IE.txt gl.txt gl_ES.txt gsw.txt\
 gsw_CH.txt \
 gv.txt gv_GB.txt ha.txt ha_Latn.txt ha_Latn_GH.txt\
 ha_Latn_NE.txt ha_Latn_NG.txt haw.txt haw_US.txt he.txt\
